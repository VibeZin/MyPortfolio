...
// --- Lines for the typewriter ---
const TYPING_LINES = [
  "Hey, I'm Shabab Ahmed Tazin.",
  "BBA student obsessed with tech.",
  "Building stuff. Learning everything. Vibing.",
];
  ...
  return (
    <PageWrapper className="min-h-screen flex flex-col justify-center relative pb-20 md:pb-0">
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 md:gap-20 items-center mt-32 md:mt-0 mb-16">
        ...
        >
          {/* Tagline badge */}
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--black-800)] border border-[var(--black-700)] text-[var(--silver)] mb-8 backdrop-blur-md">
          ...
          <motion.div variants={fadeInUp} className="mb-8">
            <TypewriterText
              ...
              typingSpeed={68}
              pauseAfterLine={720}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-left leading-tight"
              onComplete={() => setTypingDone(true)}
            />
          </motion.div>

          {/* Buttons — fade in after typing finishes */}
          <motion.div
            variants={fadeInUp}
